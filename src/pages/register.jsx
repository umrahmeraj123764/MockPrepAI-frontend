...
return (
 ...
 <div className="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-black">Sign up for your account</h2>
    </div>
    
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form onSubmit={handleSubmit}>
            <div>
                <label for="name" className="block text-sm/6 font-medium text-black">Name</label>
        <div className="mt-2">
            <input
        id='name'
        type='text'
